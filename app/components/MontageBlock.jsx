    ...
    <>
      <div className="max-w-[1272px] bg-[#FDF7F2] rounded-[80px] relative mx-auto mt-20 mb-[-50px] z-1">
        <div className="wrapper text-black lg:h-[635px] pb-12 pt-16 lg:pl-24 mx-auto z-[100]">
          ...
          Компания ABBEX предоставляет свою инструкцию <br/> по монтажу нашей продукции.
          </p>
          </div>
          
          <div className="flex text-center justify-center items-center lg:justify-between relative flex-col lg:flex-row">
            <Btn kind="btn-primary" className='mt-8 lg:relative lg:top-[-170px] h-[80px] lg:h-[110px] w-[310px] lg:w-[430px] lg:text-2xl font-bold '>Открыть инструкцию</Btn>
            <img src="/assets/BoardPiece.png" className="lg:w-[550px] xl:w-full scale-[.85] hidden lg:block mx-auto pr-8 lg:pr-0 lg:mx-0 text-base lg:text-xl lg:relative lg:top-[-250px] right-[15px]" alt="" />
          </div>
        </div>
      </div>
    </>
