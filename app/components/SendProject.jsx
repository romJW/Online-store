  ...
  return (
    <div className="wood-bg pt-32 pb-10">
        ...
        <div className="flex flex-col justify-center text-white text-center lg:text-start px-2">
            <h3 className="font-[Days] uppercase text-3xl lg:text-5xl mb-2">Отправьте ваш <br/> проект для расчета</h3>
            ...
            <p className="text-[#FFFFFFB2] text-xs lg:text-xl xl:w-[600px] mb-12">Вместе с рассчетом отправим рекомендации по монтажу террасной доски в зависимости от сферы использования (для террасы, бассейна, бани и т. д.).</p>
