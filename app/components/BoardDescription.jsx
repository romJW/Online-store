...
export default function BoardDescription() {
  return (
    <>
    <Section>
      <div className="container mx-auto flex flex-col justify-center items-center text-[#2F2222] mt-10">
        <h3 className="font-[Days] text-3xl lg:text-5xl mb-10 text-center">
          ТЕРРАСНАЯ ДОСКА ОТ <br /> ПРОИЗВОДИТЕЛЯ WOODGRAND <br /> СЛУЖИТ БОЛЕЕ 15 ЛЕТ
        </h3>
        <div className="flex gap-8 justify-center flex-col-reverse lg:flex-row mb-14">
          ...
          <div className="text-base flex flex-col justify-center items-center lg:text-2xl">
            <h4 className="font-bold ">
              Террасная доска WOODGRAND состоит <br /> из двух компонентов:
            </h4>
            <ul className="list-disc  mb-4 mr-8">
              <li>натуральная древесная мука</li>
              <li>пищевой полиэтилен низкого <br/> давления (ПНД).</li>
            </ul>
            <p className="text-start  xl:pl-20">
        ...
        <div className="container mx-auto mb-10 justify-items-center grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-8 gap-5">
