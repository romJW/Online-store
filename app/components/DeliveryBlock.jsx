...
export default function DeliveryBlock() {
  return (
    <>
      <div className="max-w-[1272px] bg-[#FDF7F2] rounded-[80px] relative mx-auto  mb-[-150px] z-40">
        <div className="wrapper text-black lg:h-[500px] pt-20 pl-10 mx-auto ">
          ...
          <div className="flex text-center justify-center items-center lg:justify-between relative flex-col lg:flex-row">
            <Btn kind="btn-primary" className='lg:relative lg:top-[-100px] h-[110px] text-base xl:text-2xl font-bold w-[300px] xl:w-[580px]'>Рассчитать стоимость доставки</Btn>
