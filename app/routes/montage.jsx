      ...
      <>
        <Section>
          <div className="mx-auto mt-20 text-black container">
            ...
            <p className='text-center text-2xl lg:text-3xl mb-10'>У нас вы можете заказать материал и последующий монтаж «под ключ»</p>
              ...
              <div className="swiper-wrapper swiper-wrapper-montage py-20 mx-auto relative">
                {catalogCards.map((card) => {
                  return (
                    <div
                      key={card.image}
                      className="swiper-slide  flex items-center justify-center w- lg:w-[370px]">
                      <MontageSliderCard
